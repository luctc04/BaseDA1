...
--
-- Host: localhost:3306
-- Generation Time: Dec 11, 2023 at 01:52 PM
...
(20, 'hahha', 31, 64, '16:17:04pm 10/12/2023'),
(21, 'mèo này có thịt đc kh ạ??\r\n', 31, 64, '13:01:05pm 11/12/2023');
...
(85, 107, 63, 7500000.00, 1, 7500000.00),
(89, 110, 61, 6000000.00, 3, 18000000.00);
...
(5, 'admin', '123', 'truongcongluc2004@gmail.com', 'Bích Hòa, Thanh Oai, Hà Nội', '0332293871', 1),
(31, 'luc', '123', 'luctcph37171@fpt.edu.vn', 'Bích Hòa, Thanh Oai, Hà Nội', '0332293871', 0);
...
(104, 31, 'Trương Công Lực', '0332293871', 'luc@gmail.com', 'hà đông, hà nội\r\n', 44444.00, 1, '2023-12-08 18:57:01', 4),
(107, 31, 'luctest', '0332293871', 'luc@gmail.com', 'bích hòa, thanh oai, hà nội ', 7500000.00, 1, '2023-12-10 23:17:27', 2),
(110, 31, 'test', '0332293871', 'truongcongluc2004@gmail.com', 'bích hòa, thanh oai, hà nội ', 18000000.00, 2, '2023-12-11 20:07:08', 1);
...
--
ALTER TABLE `order_detail`
  MODIFY `id_order_detail` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=90;
...
--
ALTER TABLE `tbl_order`
  MODIFY `id_order` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=111;
